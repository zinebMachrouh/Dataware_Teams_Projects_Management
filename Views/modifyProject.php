        ...
        <form action="" method="post">
            <?php
                ...
                echo '
                    <label for="name">
                        <h4>Project Name</h4>
                        <input type="text" name="name" id="name" required placeholder="Enter Project Name" value='.$project['name']. '>
                    </label>
                    <label for="date_start">
                        <h4>Start Date</h4>
                        <input type="date" name="date_start" id="date_start" required value=' . $project['date_start'] . '>
                    </label>
                    <label for="date_end">
                        <h4>End Date</h4>
                        <input type="date" name="date_end" id="date_end" required value=' . $project['date_end'] . '>
                    </label>
                    <label for="status">
                        <h4>Status</h4>
                        <select name="status" id="status">
                            <option value=' . $project['status'] . ' selected hidden>Pick a status</option>
                    ...
                    <label for="description">
                        <h4>Description</h4>
                        <input type="text" name="description" id="description" placeholder="lorem ipsum doleres" value=' . $project['description'] . '>
                    </label>
                    <div class="btns">
