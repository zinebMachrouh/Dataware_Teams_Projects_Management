...
<body class="login-body">
    ...
    <div class="create-form">
        ...
        <div class="labels med">
            <label for="fname">
                <h4>First Name</h4>
                <input type="text" name="fname" id="fname" required placeholder="Enter First Name" value=' . $user['fname'] . '>
            </label>
            <label for="lname">
                <h4>Last Name</h4>
                <input type="text" name="lname" id="lname" required placeholder="Enter Last Name" value=' . $user['lname'] . '>
            </label>
        </div>
        ...
        <label for="adress" class="sm">
            <h4>adress</h4>
            <input type="text" name="adress" id="adress" placeholder="1220 Dream Street Fantasyland, FL 54321 United Imaginary States" value="' . $user['adress'] . '">
        </label>
            <label for="service" class="sm">
                ...
                <h4>Password</h4>
                <input type="text" name="pswd" id="pswd" placeholder="XXXXXXXX" value=' . base64_decode($user['password']) . '>
            </label>
    ';
            ?>
